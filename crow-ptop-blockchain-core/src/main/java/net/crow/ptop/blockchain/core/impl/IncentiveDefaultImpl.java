...
public class IncentiveDefaultImpl extends Incentive{
    ...
    public BigDecimal mineAward(BlockChainDataBase blockChainDataBase, Block block) throws Exception {
        ...
        //区块固定奖励
        BigDecimal mixedCoin = GlobalConfig.MinerConstant.INIT_MINE_BLOCK_INCENTIVE_COIN_AMOUNT;
        ...
        if(BigIntegerUtil.isLessEqualThan(blockHeight,BigInteger.ONE)){
            ...
            long timestamp = GlobalConfig.MinerConstant.MINE_BLOCK_INCENTIVE_REDUCE_BY_HALF_INTERVAL_TIMESTAMP;
        ...
        //小数位数
        BigDecimal setScaleTotal = total.setScale(GlobalConfig.TransactionConstant.TRANSACTION_AMOUNT_MAX_DECIMAL_PLACES,BigDecimal.ROUND_DOWN);
